---
title: "F-16 Fighting Falcon Fighter Jet: Its History and Current State"
meta_title: "F-16 Fighting Falcon Fighter Jet: Its History and Current State"
description: "The F-16 fighter jet is a long-running aircraft used by the US and its allied partners. Learn about its history and current state in this article."
date: 2026-01-31T13:00:00+02:00
draft: false
thumb: "/31012026/cover.png"
thumb_alt: "A USAF F-16 pilot breaking right on final approach over northern Las Vegas"
author: "vanessa-fransia"
is_article: true
---

{{< img src="/31012026/cover.png" id="i\_plane" caption="Master Sgt. Benjamin Bloker / Wikimedia" alt="A USAF F-16 pilot breaking right on final approach over northern Las Vegas.">}}
...
The [first F-16](https://www.britannica.com/technology/F-16) was a single-seat, single-engine jet fighter developed by the General Dynamics Corporation towards the end of the war in Vietnam, when the Soviet Mikoyan-Gurevich (MiG) overwhelmed heavier and slower US fighter planes. The United States and four NATO countries, namely Belgium, Denmark, the Netherlands and Norway, agreed to produce a lightweight, highly maneuverable, and cost-effective air-to-air fighter in 1972. The long-term benefits of this program was technology transfer among the agreeing nations, and a common-use aircraft for NATO nations.

The resulting F-16 was assembled from components manufactured in all five countries, and took its first flight in 1974. In January 1979, the [first operational F-16A](https://www.hill.af.mil/About-Us/Fact-Sheets/Display/Article/104505/f-16-fighting-falcon/) was delivered to the 388th Tactical Fighter Wing at Hill Air Force Base, Utah.
...
{{< img src="/31012026/1.png" id="i\_plane" caption="Staff Sgt. Cherie A. Thurlby / Wikimedia" alt="A US Air Force F-16 Fighting Falcon flies a mission in the skies near Iraq on March 22, 2003 during Operation Iraqi freedom.">}}

The [F-16](https://www.af.mil/About-Us/Fact-Sheets/Display/Article/104505/f-16-fighting-falcon/) entered operational service in January 1979, when the first F-16A was delivered to the 388th Tactical Fighter Wing at Hill Air Force Base in Utah. Designed from the outset as a lightweight yet highly capable fighter, the aircraft introduced several innovations that set new standards in modern combat aviation.

Here are the details of the F-16’s design and capability:

- **Length:** 49 feet (15 meters)
- **Wingspan:** 31 feet (9.45 meters)
- **Powered by:** single turbofan engine, the Pratt and Whitney F100-PW-200/220/229 
- **Thrust output:** 23,000–29,000 lb (102–130 kN) with afterburner
- **Wing material:** Aluminum-alloy for improved lift and stability
- **Internal 20-mm rotary cannon**
- **Multiple hardpoints under wings and fuselage for bombs and missiles**
- **Approximate combat weight:** 23,000 lb (10,000 kg)

{{< img src="/31012026/2.png" id="i\_plane" caption="US Air Force Staff Sgt. John Raven / Wikimedia" alt="F-16 Fighting Falcon at Eglin Air Force Base.">}}
...
The original F-16A was a single-seat aircraft, while the [F-16B](https://www.jble.af.mil/About-Us/Fact-Sheets/show/Article/440839/f-16-fighting-falcon/) served as a two-seat version with a pair of cockpits and a bubble canopy that stretched to cover the second cockpit. During training, a student pilot occupies the forward cockpit while the instructor stays in the rear cockpit.
...
The F-16 is known for its speed and agility. It was the first production fighter aircraft specifically designed to sustain 9-g maneuvers, giving it superior capability. Powered by a single turbofan engine and supported by its fly-by-wire control system, the aircraft can reach a maximum speed of over [Mach 2](https://www.wionews.com/photos/how-fighter-jets-cross-100-km-in-under-6-minute-1764326658391) at an altitude of 40,000 feet, which equals to approximately 1,500 miles per hour.

{{< img src="/31012026/3.png" id="i\_plane" caption="SrA Briana Jones / Wikimedia" alt="A US Air Force F-16 Fighting Falcon aircraft pilot prepares to depart Aviano Air Base, Italy, during a close air support training exercise">}}
...
{{< img src="/31012026/4.png" id="i\_plane" caption="US Air Force / Wikimedia" alt="USAF aircraft of the 4th Fighter Wing (F-16, F-15C and F-15E) fly over Kuwaiti oil fires, set by the retreating Iraqi army during Operation Desert Storm in 1991.">}}

Throughout its service history, the F-16 has established a strong combat record, demonstrating its versatility in both the air-to-air role (with a [76-to-1 kill ratio](https://nationalsecurityjournal.org/the-f-16-fighter-first-flew-in-1974-and-is-still-a-powerhouse/)) and the air-to-ground role. The F-16 models have been sold to US allies in the Middle East, where it has been used in air-to-air combat and ground attack in the Israeli-Syrian conflict of 1982 as well as the Persian Gulf War of 1990–91. This fighter jet has also been deployed in nearly every [major US military conflict](https://thefriendlyskies.net/article/exploring-the-largest-us-military-base-size-and-operations/). Here is a look at five of the F-16’s notable [combat engagements in history](https://simpleflying.com/top-5-combat-achievements-f-16-fighting-falcon/). 
...
Having been in production for so long, F-16 prices have changed over the years. [Executive Flyers](https://executiveflyers.com/how-much-does-a-f-16-cost/) found that the early F-16A and F-16B variants sold in the early 1980s for around $13 million. The improved F-16C and F-16D variants sold for close to $20 million. Meanwhile, newer variants, the F-16E and F-16F command a starting price of $25 to $30 million. Further improvements and equipment may even increase the price further to a range of $60 to $70 million.

## The Current State: Evolution and Legacy

{{< img src="/31012026/5.png" id="i\_plane" caption="Staff Sgt. Matthew Bruch / Wikimedia" alt="Members of the Alabama Air National Guard's 187th Fighter Wing pose for a photo in front of an F-16 Fighting Falcon and Romanian Air Force MiG-21 Lancer on 71st Air Base, Campia Turzii, Romania during Exercise Dacian Viper, Oct. 23, 2015.">}}

Over the decades, the F-16 has undergone [continuous upgrades](https://www.lockheedmartin.com/en-us/products/f-16.html) to secure its place along 5th-generation jets such as the [F-35](https://thefriendlyskies.net/article/lockheed-martin-f-35-lightning/). Key upgrades include:

- Enhanced avionics, radar, and weapons integration for F-16C/D Block 50/52.
- Addition of Army-Navy, Airborne, Pulse-Doppler, Fire-Control Radar-83 (AN/APG-83) active electronically scanned array (AESA) radar, upgraded mission computers, modern cockpit displays, advanced electronic warfare systems, and a structural life extension program (SLEP) to 12,000 flight hours for the F-16V “Viper” Upgrade.
- Weapons integration to be compatible with Air Intercept Missile-120 (AIM-120) Advanced Medium-Range Air-to-Air Missile (AMRAAM), AIM-9X Sidewinder, Joint Direct Attack Munitions (JDAMs), and precision-guided munitions.
