...
draft: false
thumb: "/01012026/cover.jpg"
thumb_alt: "Airplane window with a view."
author: "vanessa-fransia"
is_article: true
---

{{< img src="/01012026/cover.jpg" id="i\_plane" caption="ArtPhoto\_studio / Freepik" alt="Airplane window with  a view.">}}
...
{{< img src="/01012026/1.jpg" id="i\_plane" caption="Government of the United Kingdom / Wikimedia" alt="Comet 1 prototype (with square windows) at Hatfield Aerodrome in October 1949.">}}

Airplane windows have not always been round. In fact, windows were not part of early aviation history. When the Wright Brothers made the first sustained flight by their [aircraft in 1903](https://airandspace.si.edu/explore/stories/researching-wright-way), they focused more on achieving powered flight rather than passenger comfort. 
...
The [Federal Aviation Administration (FAA)](https://www.faa.gov/lessons_learned/transport_airplane/accidents/G-ALYV) documented how square plane windows were a contributing factor to several accidents involving some planes in the early 1950s. Initially, the de Havilland Comet airplanes entered service in 1952, faster and more advanced than any planes built before it. However, the program later on faced disaster. 

The first accident occurred in May 1953, when [British Overseas Airways Corporation (BOAC) Flight 783](https://aviation-safety.net/wikibase/335368) departed from Calcutta, India. After climbing to 7,500 feet, the plane broke up and crashed, killing everyone on board. The cause of the accident was determined to be structure failure from flying through a storm, or over-control of the aircraft by the pilot.

{{< img src="/01012026/2.jpg" id="i\_plane" caption="HM Stationery Office / Wikimedia" alt="An image from the accident investigation into Comet 1 G-ALYP and G-ALYY showing fuselage failure at escape hatch.">}}

On 10 January 1954, [BOAC Flight 781](https://admiralcloudberg.medium.com/neither-money-nor-manpower-the-story-of-the-de-havilland-comet-and-the-crash-of-boac-flight-781-36db2a3435ce) was scheduled to depart from Rome to London. However, the jet suffered an explosive decompression at altitude and crashed near the Mediterranean Sea, killing all 35 people on board. The reason for the crash was determined to be explosive decompression from metal fatigue, originating from the corners of the square windows.

In April of the same year, [South African Airways Flight 201](https://www.thisdayinaviation.com/tag/flight-201/) also crashed over the Mediterranean Sea, killing everyone on board. As a result, The Certificate of Airworthiness was withdrawn for all aircraft, grounding the fleet indefinitely. 
...
The presence of sharp corners on square plane windows may increase [stress](https://www.aviathrust.com/article/Aloha-Flight-243-ARTICLE-SERIES-3) on the metal, leading to the formation of cracks. These cracks may spread and lead to structure failure. This proved how the window design in airplanes had to change, as curves are stronger than corners.

## The Importance of Round Airplane Windows

{{< img src="/01012026/3.jpg" id="i\_plane" caption="Angelo Abear / Unsplash" alt="An image of a plane window.">}}
...
Although aircrafts are designed to reduce the risk of the plane windows breaking, there have been several cases where it has happened. The first was the [British Airways Flight 5390](https://assets.publishing.service.gov.uk/media/5422faa7e5274a131400078d/1-1992_G-BJRT.pdf), which was scheduled for a flight from Birmingham Airport in England to Málaga Airport in Spain on June 10, 1990. A poorly installed windscreen panel fell out, causing the flight captain to be sucked out of the plane, only held in by flight staff. He survived with a fractured arm, frostbite and some minor injuries.

{{< img src="/01012026/4.jpg" id="i\_plane" caption="Air Accidents Investigation Branch, Department for Transport, UK / Wikimedia" alt="Illustration that shows correct and incorrect screws used in the G-BJRT windscreen that failed during the flight of British Airways flight 5390.">}}

Another example that happened decades later was the [Southwest Airlines Flight 1380](https://www.airwaysmag.com/legacy-posts/southwest-flight-1380), a Boeing 737-7H4 flying from LaGuardia Airport, New York, to Dallas Love Field, Texas on April 17, 2018. One of its passenger windows broke due to an exploding engine, killing one passenger due to being partially sucked out of the plane.

Shortly after, on May 14, 2018, another plane had the same issue. [Sichuan Airlines Flight 8633](https://www.bbc.com/news/world-asia-china-44121377), bound from Chongqing Jiangbei International Airport to Lhasa Gonggar Airport, had to make an emergency landing due to its cockpit windshield blowing out at 32,000 feet. The first officer was sucked out of the aircraft, sustaining minor injuries. All 128 people on board survived.
...
While typically focusing on spacecraft, [Zeiss](https://www.popsci.com/technology/airplane-smart-glass/#:~:text=Smart%20glass%20windows%20would%20beam,over%20scenic%20views%20%7C%20Popular%20Science) is eyeing to upgrade the existing window panels in planes, blending the real-world view with digital overlays and controls. The new technology was displayed in the 2025 Aircraft Interiors Expo in Hamburg, Germany back in April this year. According to Zeiss, using multifunctional smart glass windows also offer the added advantage of reducing the plane’s overall weight.

{{< img src="/01012026/5.jpg" id="i\_plane" caption="Otto Aviation / Wikimedia" alt="Otto Phantom 3500.">}}

[Otto Aerospace](https://simpleflying.com/windowless-cabins-future-business-aviation-us/#:~:text=Windows%20are%20a%20pleasant%20feature,more%20accessible%20for%20regular%20travelers?), a US aerospace company focusing on highly efficient [private and business jets](https://thefriendlyskies.net/article/why-private-jets-fly-higher-than-commercial/), also recently designed the Phantom 3500 jet. In addition to having a teardrop-shaped fuselage, it is windowless, except for the cockpit. The aircraft design is meant to reduce fuel consumption and increase range. Screens are fitted into the cabin sides where windows are usually placed, with ‘smart windows’ that show the exterior of the aircraft. Passengers can also switch them to watch TV or have virtual meetings. 
